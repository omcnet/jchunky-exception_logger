...
I forked http://github.com/QuBiT/exception_logger to get it working with Rails 3.0.0.
...
Inside your Gemfile:
  ...
  gem 'exception_logger', '0.1.6', :git => 'git://github.com/jchunky/exception_logger.git' 
